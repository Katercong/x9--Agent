...
def _system_prompt(reply_language: str, prompt_version: str, rule_category: str) -> str:
    ...
    return (
        ...
        "not_interested -> acknowledge_and_close / dropped / requires_human_review=true\n"
        ...
        "Campaign detail policy: only use campaign_timeline, campaign_deliverables, and budget_guidance when those "
        "fields are supplied in the product context. If the creator asks for a missing detail, do not invent or promise "
        "a number, date, deliverable, or approval. Write a brief acknowledgement and mark the missing detail for human review."
    )
