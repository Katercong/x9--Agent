...
# ============================================================
def _call(provider: dict, *, messages: list[dict], system: str | None = None,
    ...
    if typ == "anthropic":
        ...
        return _call_openai_compat(provider, messages, system, model, max_tokens, temperature)
    raise ValueError(f"unknown provider type {typ!r}")


def _call_anthropic(p: dict, messages: list[dict], system: str | None,
