...
"%PY%" scripts\migrate_v2.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v3.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v4.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v5.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v6.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v7.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v8.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v9.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v10.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v11.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v12.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v13.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v14.py >/dev/null 2>/dev/null
"%PY%" scripts\migrate_v15.py >/dev/null 2>/dev/null
