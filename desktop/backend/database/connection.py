...
def _ensure_schema_columns() -> None:
    ...
    with engine.begin() as conn:
        ...
        _ensure_column(conn, "email_auto_campaigns", "queue_window_key", "VARCHAR(80)")
        _ensure_column(conn, "email_auto_campaigns", "queue_cleared_window_key", "VARCHAR(80)")
        ...
        _ensure_index(conn, "ix_email_auto_campaigns_queue_window_key", "email_auto_campaigns", "queue_window_key")
        ...
        _ensure_column(conn, "email_auto_jobs", "queue_window_key", "VARCHAR(80)")
        ...
        _ensure_index(conn, "ix_email_auto_jobs_queue_window_key", "email_auto_jobs", "queue_window_key")
