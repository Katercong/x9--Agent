...
def _event_from_legacy_status(status: Any) -> str | None:
    ...
    mapping = {
        ...
        "needs_follow_up": "pending_followup",
    ...
    *,
    ...
    return {
        ...
        "summary": {
            ...
            "pending_followup": event_counts.get("pending_followup", 0) + event_counts.get("pending_reply", 0),
            "pending_reply": event_counts.get("pending_followup", 0) + event_counts.get("pending_reply", 0),
