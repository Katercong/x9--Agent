...
BACKEND_URL = f"{DEFAULT_BACKEND_BASE}/api/companies/ingest"
TALENT_URL = f"{DEFAULT_BACKEND_BASE}/api/talents/ingest"
...
TALENT_BACKEND_URL = f"{DEFAULT_BACKEND_BASE}/api/talents/ingest"
