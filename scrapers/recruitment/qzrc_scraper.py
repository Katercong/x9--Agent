...
用法:
  & "F:\python_envs\notebooklm\Scripts\python.exe" scraper/qzrc_scraper.py --mode resume --inspect --max-pages 1 --keywords "跨境销售"
  & "F:\python_envs\notebooklm\Scripts\python.exe" scraper/qzrc_scraper.py --mode resume --max-pages 10
"""
