...
export function useYoutubeStats() {
  return useQuery({
    ...
    queryFn: () => api.get<YoutubeStats>('/youtube/stats'),
...
export function useYoutubeActors() {
  return useQuery({
    ...
    queryFn: () => api.get<YoutubeActorsResponse>('/youtube/actors'),
    refetchInterval: 30_000,
  });
}
...
export function useYoutubeRuns(params: { limit?: number; offset?: number }) {
  return useQuery({
    ...
    queryFn: () => api.get<YoutubeListResponse<YoutubeImportRun>>('/youtube/runs', params),
  });
}
...
export function useYoutubeLeads(params: YoutubeLeadParams) {
  return useQuery({
    ...
    queryFn: () => api.get<YoutubeListResponse<YoutubeLead>>('/youtube/leads', params),
  });
}
...
export function useYoutubeManualReview(params: Omit<YoutubeLeadParams, 'has_email' | 'needs_manual_review'>) {
  return useQuery({
    ...
    queryFn: () => api.get<YoutubeListResponse<YoutubeLead>>('/youtube/manual-review', params),
  });
}
...
export function useYoutubeSources(leadId: string | null, params: { limit?: number; offset?: number }) {
  return useQuery({
    ...
    queryFn: () =>
      api.get<YoutubeSourcesResponse>('/youtube/sources', {
        lead_id: leadId,
        ...params,
      }),
  });
