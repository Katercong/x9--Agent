...
class Creator(Base):
    ...
    # ---- Acquisition source (which of the 3 channels this creator came from) ----
    source: Mapped[str | None] = mapped_column(String(60), index=True, nullable=True)
    avatar_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    shop_profile_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    lead_status: Mapped[str | None] = mapped_column(String(40), index=True, nullable=True)
